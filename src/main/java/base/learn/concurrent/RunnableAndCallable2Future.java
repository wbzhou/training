 ...
 * 
 *ExecutorService 的 submit有返回值，而execute没有
 */
...
public class RunnableAndCallable2Future {
	...
	public static void main(String[] args) {
		...
		// 创建一个执行任务的服务
	    ExecutorService executor = Executors.newCachedThreadPool();//带缓存的不够时自动添加
		//ExecutorService executor = Executors.newFixedThreadPool(3);//创建固定容量大小的缓冲池
		try {
